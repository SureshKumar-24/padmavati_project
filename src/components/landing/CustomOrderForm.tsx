  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`w-full px-4 py-3 text-left bg-white border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all ${
      ...
      {isOpen && (
        <div className="absolute z-20 w-full mt-2 bg-white border-2 border-amber-200 rounded-xl shadow-lg overflow-hidden">
          {options.map((option) => (
            <button
              key={option}
              type="button"
...
export function CustomOrderForm() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-amber-900 via-amber-800 to-orange-900 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-14">
          <span className="inline-block px-4 py-1.5 bg-amber-500/20 border border-amber-400/30 rounded-full text-amber-200 text-sm font-medium mb-4">
            Made to Order
          </span>
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {formData.designFile ? (
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <div className="text-left">
                        <p className="font-medium text-gray-900">{formData.designFile.name}</p>
                        <p className="text-sm text-gray-500">{(formData.designFile.size / 1024).toFixed(1)} KB</p>
                      </div>
                    </div>
                  ) : (
                    <>
                      ...
                      <p className="text-gray-400 text-sm mt-1">or click to browse (PNG, JPG, PDF)</p>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 hover:border-amber-300 transition-all resize-none"
                />
              </div>
              ...
              <div className="md:col-span-2">
                <button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-semibold text-lg rounded-xl hover:from-amber-700 hover:to-amber-800 transition-all shadow-lg shadow-amber-600/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
          ...
          {/* Trust Indicators */}
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-amber-200/80 text-sm">
